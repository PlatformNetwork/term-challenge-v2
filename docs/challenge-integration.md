...
This guide explains how to integrate challenge crates with the Platform validator network. All challenge execution is **WASM-only**.
...
3. Validators load the WASM module into the sandboxed runtime.
