...
use crate::{
    BlockHeight, ChainState, ChallengeConfig, ChallengeId, Hotkey, Job, NetworkConfig, Result,
    Score, SignedMessage, StateSnapshot, ValidatorInfo,
};
...
pub enum SudoAction {
    ...
    /// Add a new challenge with WASM module
    AddChallenge {
        name: String,
        description: String,
        wasm_code: Vec<u8>,
    ...
    /// Stop network - burn all emissions to UID 0
    StopNetwork { reason: String },
}
